...
public class AddTaxisFragment extends Fragment {
    ...
    public static AddTaxisFragment newInstance(String param1, String param2) {
        AddTaxisFragment fragment = new AddTaxisFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getActivity();
        view = inflater.inflate(R.layout.fragment_add_taxis, container, false);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        dashboardActivity.setTitle("Add Taxis");
