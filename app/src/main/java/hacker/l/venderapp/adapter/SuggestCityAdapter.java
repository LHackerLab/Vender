...
public class SuggestCityAdapter extends RecyclerView.Adapter<SuggestCityAdapter.MyViewHolder> implements Filterable {
    ...
    public SuggestCityAdapter(Context mContext, List<Result> dataList) {
...
//        this.materialdesignicons_font = FontManager.getFontTypefaceMaterialDesignIcons(mContext, "fonts/materialdesignicons-webfont.otf");
    ...
    @Override
    public SuggestCityAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_suggest_city, parent, false);

        return new SuggestCityAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(SuggestCityAdapter.MyViewHolder holder, final int position) {
        if (position % 2 == 1) {
